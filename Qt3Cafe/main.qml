...
Window {
    ...
    width: 800
    height: 550
    title: qsTr("Справочник любителя кафе")
    ...
    Button {
        ...
        onClicked: {
            ...
            var typeCafe = cafeList.currentItem.cafeData.typeOfCafe
            var timeCafe = cafeList.currentItem.cafeData.timeOfCafe

            windowEdit.execute(nameCafe, addressCafe, typeCafe, timeCafe, cafeList.currentIndex)
        }
    }
    ...
    Button {
        ...
        Label {
            ...
            text: qsTr("Введите нужный тип кухни заведения:")
        }
        TextField {
            id: textSelArea
